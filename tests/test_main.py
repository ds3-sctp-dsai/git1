...
def test_bmi_from_pounds():
    # 154 lb converted correctly: 69.8532 kg → BMI 22.81, NOT 50.32
    weight_kg = pounds_to_kg(154)
    # This checks if the result is 22.81 within a small tolerance
    assert calculate_bmi(weight_kg, 1.75) == approx(22.81, rel=1e-2)
